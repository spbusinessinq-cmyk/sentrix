...
const SENSITIVE_PERSON_RE = /\b(is|does|has|was|have|had)\b.{0,40}\b(he|she|they|him|her|them|[A-Z][a-z]+(?:\s+[A-Z][a-z]+)?)\b/i;

function detectSensitiveClaim(input) {
  if (!SENSITIVE_CLAIM_RE.test(input)) return false;
  // Only flag when it's about a person (not general medical news)
